...
export default function UnrankedPanel(p: Props) {
  return (
    <footer className="text-center mt-8 sm:mt-6">
      <div className="mb-4 bg-slate-800 rounded-lg p-2 sm:rounded-none sm:bg-transparent">
        ...
        <details className="sm:hidden">
          <summary className="fixed bottom-16 left-3 right-3 hit rounded-full shadow-md border bg-background/95 backdrop-blur flex items-center justify-between px-4 py-3">
            <span className="text-sm font-medium">Unranked</span>
            <span className="text-sm opacity-70">{p.unrankedCount}</span>
          </summary>
